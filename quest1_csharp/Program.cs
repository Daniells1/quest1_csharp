...

{
...

    {
...

        {
            ...
            var trying = int.Parse(Console.ReadLine());
...

            {
                ...
                var dragonballs = int.Parse(Console.ReadLine());

                Console.WriteLine(dragonballs - Math.Floor(Math.Sqrt(dragonballs)));
